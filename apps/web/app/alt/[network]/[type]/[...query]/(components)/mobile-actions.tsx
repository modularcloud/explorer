...
import { DialogPanel, RightSidebarOff, SearchOff } from "@modularcloud/design-system";

export function MobileActions() {
    return <div className="flex gap-4 items-center lg:hidden">
            <DialogPanel
              ...
              removeCloseBtn
            >
              <div className="max-w-[80%] m-auto shadow-lg">Search goes here</div>
            </DialogPanel>

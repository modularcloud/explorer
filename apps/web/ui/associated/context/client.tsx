...
export const AssociatedViewDispatchContext =
  createContext<Dispatch<AssociatedViewType> | null>(null);
...
export function ClientAssociatedViewContextProvider({
  value,
  children,
}: Props) {
  const [view, dispatch] = useReducer(
    reducer,
    value ?? DEFAULT_ASSOCIATED_VIEW
  );
  return (

  ...
  return (
    <DropdownMenuPrimitive.Trigger
      ...
      className={cn(
        ...
        "focus:outline-none py-1 text-sm",
        "ring-primary/20 focus:border-primary focus:ring-2",
        className,
      )}
    />
  );
  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        ...
        "z-50 min-w-[8rem] overflow-hidden rounded-md border bg-white text-foreground shadow-md",
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ...
    className={cn(
      ...
      "data-[highlighted]:bg-mid-dark-100",
      className,
    )}
    {...props}
  >

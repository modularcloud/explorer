...
Modular Cloud enables [NautScan](https://nautscan.com) users to verify contracts on the [Nautilus Mainnet network](https://docs.nautchain.xyz/nautilus-mainnet) and the [Nautilus Proteus Testnet](https://docs.nautchain.xyz/nautilus-testnet), powered by [Sourcify](https://sourcify.dev/). This feature will be released generally to all chains in the future.
...
3. Ensure **Nautilus Mainnet** or **Nautilus Proteus Testnet** is selected in the dropdown depending on which network the contract is deployed on.

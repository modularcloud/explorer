...
1. Click to browse your File Explorer for the .sol contract file and .json metadata file for upload
    ...
    - Before starting with the verification process, if the contract is deployed through hardhat make sure you've parsed the Hardhat `.json` output file located under `artifacts/build-info`. This file contains necessary details about the compiled contract.

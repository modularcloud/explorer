...
Modular Cloud enables [NautScan](https://proteus.nautscan.com) users to verify contracts on the [Proteus network](https://docs.nautchain.xyz/nautilus-testnet#goerli), powered by Sourcify. This feature will be released generally to all chains at a later date.
...
3. Ensure **Nautilus Proteus Testnet** is selected in the dropdown.

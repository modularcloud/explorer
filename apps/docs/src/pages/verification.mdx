...
#### 1. Click to browse your File Explorer and select the .json metadata file to upload

  Before starting with the verification process, if the contract is deployed through hardhat make sure you've parsed the Hardhat `.json` output file located under `artifacts/build-info`. This file contains the necessary details about the compiled contract.

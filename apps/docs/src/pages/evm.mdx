...
<Row>
  <Col>
    ...
    Given an account address, returns balance of the ERC20/ERC721/ERC1155 token this address own and the native token balance.

    ### Parameters

    <Properties>
      <Property name="tokenType" type="string">
        Optional. If not specified, the defautl is ERC20.
      </Property>
      <Property name="maxResults" type="integer">
    ...
    <Properties>
          <Property name="tokenType" type="string">
            String indicating ERC20, ERC721, or ERC1155.
          </Property>
          ...
          <Property name="token {decimals}" type="int">
            The number of significant figures used in this token's ledger of balances.
          </Property>
          <Property name="balance {value}" type="string">
            Stringified representation of the address balance in WZBC.
          </Property>
           <Property name="nativeTokenBalance" type="int">
            EXPLANATION NEEDED
          </Property>
        </Properties>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request Example" tag="GET" label="/token-balances/:account-address?tokenType=<token-type>">

    ```bash {{ title: 'cURL' }}
    curl -G https://{base-url}/eclipse/91002/token-balances/0x91affdc81adb827e47449d730df40737241972bc
    ```
...
<Row>
  <Col>
    ...
    <Properties>
          ...
          <Property name="transactionHash" type="string">
            The stringified hash of the transaction.
          </Property>
          <Property name="logIndex" type="int">
            Position of the transaction in the block's index.
          </Property>
          <Property name="blockHeight" type="int">
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -G https://{base-url}/eclipse/91002/token-events/0x390ac9d456c839c1796053ac903b4d0815fbd5b0?maxResults=2
    ```
...
<Row>
  <Col>
    ...
    Given an account address, returns a list of an account's transaction events.
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -G https://{base-url}/eclipse/91002/account-events/0xfaf045a4d1087cc233163ef27f10e9c79803a343?maxResults=2
    ```
...
<Row>
  <Col>
    ...
    Returns a basic description of the token's high level contract properties.
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -G https://{base-url}/eclipse/91002/token/0x027ec8e138edfb9b2548104872ff86531337b677
    ```
...
<Row>
  <Col>
    ...
    Given an holder address, returns a list of all account addresses and associated balances.
    ...
    <Properties>
          ...
          <Property name="balance" type="string">
            The balance of the preceding address.
          </Property>
        </Properties>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -G https://{base-url}/eclipse/91002/holder-balances/0x390ac9d456c839c1796053ac903b4d0815fbd5b0?maxResults=2
    ```
...
<Row>
  <Col>
    ...
    <Properties>
          ...
          <Property name="blockNumber" type="string">
            Stringified block number which contains the transaction above.
          </Property>
        </Properties>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -G https://{base-url}/eclipse/91002/transactions/0x8f19acb3a9aa25860e58aa425ceaabc485c4433a
    ```
...
## List Transactions {{ tag: 'GET', label: '/transactions' }}

<Row>
  <Col>

    Given provider and chainID, returns transactions sorted by block number.
    ...
    <Properties>
          ...
          <Property name="blockTime" type="string">
            Stringified hash of when the block was confirmed.
          </Property>
        </Properties>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -G https://{base-url}/clo/1/transactions
    ```
...
<Row>
  <Col>
    ...
    Given provider, chainID and contract address, returns logs sorted by block time.
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -G https://{base-url}/eclipse/91002/contracts/0xcf321c45ee5a755ee8220c3f103facc398b16f5d
    ```
...
<Row>
  <Col>
    ...
    Given provider, chainID and NFT token address, returns a list of collections this NFT minting has. Works for ERC721 and ERC1155. Returns a 400 error if the address is not an NFT.
...
<Row>
  <Col>
    ...
    Given provider, id, address and tokenId , returns a list of owners and balances. ERC721 may only have a single result in the owners array. ERC1155 may have more than one result, sorted by balance.
    ...
    <Properties>
          ...
          <Property name="balance{tokenId}" type="string">
            The token ticker symbol or full name.
          </Property>

  ...
  <Col>
    ...
    <Properties>
          <Property name="transferType" type="string">
            The type of token transfer that occurred, including `erc1155-trfr`, `erc20-trfr`, and `erc721-trfr`.
          </Property>
          <Property name="transactionHash" type="string">
            The cryptographic hash of the transaction.
          </Property>
          <Property name="logIndex" type="number">
            Position of the log entry in the block.
          </Property>
...
<Row>
  <Col>
    ...
    <Properties>
        <Property name="maxResults" type="number">
          Optional. If not specified, the default is 30.
          The returned result is sorted by blockNumber from the latest first.
        </Property>
        <Property name="nextToken" type="string">
            The token queued for the next request. Inputs the previous response value for the subsequent query.
        </Property>
    ...
    <Properties>
          <Property name="eventType" type="string">
            The type of transaction event that occurred.
          </Property>
          <Property name="transactionHash" type="string">
...
<Row>
  <Col>
    ...
    Given an `erc20` token address, returns a list of all token holder addresses and associated token balances.
  ...
  <Col>
    ...
    <Properties>
          ...
          <Property name="blockNumber" type="string">
            The hex-encoded number indicating the position of the block within the blockchain. This block contains the specified transaction.
          </Property>
        </Properties>
...
<Row>
  <Col>
    ...
    Given the contract address, returns logs sorted by the block number.
...
<Row>
  <Col>
    ...
    Given the provider, chainId and contract address, returns contract. Returns “not found” if the address is not an existing contract.
...
<Row>
  <Col>
    ...
    Given an NFT token address, this function returns a list of collections associated with the NFT minting. It is compatible with both ERC721 and ERC1155 standards. If the provided address is not recognized as an NFT, 400 error will be returned.
...
<Row>
  <Col>
    ...
    Given an address and a tokenId, this function returns a list of owners along with their respective balances.
    
    For the ERC721 standard, the owners array may contain only a single entry since each token ID represents a unique asset.
    
    For the ERC1155 standard, the owners array can have multiple entries, which are sorted by balance.

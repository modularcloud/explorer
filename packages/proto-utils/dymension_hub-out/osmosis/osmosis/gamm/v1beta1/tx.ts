...
function createBaseMsgJoinPool(): MsgJoinPool {
  return { sender: "", poolId: Long.UZERO, shareOutAmount: "", tokenInMaxs: [] };
}
...
function createBaseMsgExitPool(): MsgExitPool {
  return { sender: "", poolId: Long.UZERO, shareInAmount: "", tokenOutMins: [] };
}
...
function createBaseMsgJoinSwapExternAmountIn(): MsgJoinSwapExternAmountIn {
  return { sender: "", poolId: Long.UZERO, tokenIn: undefined, shareOutMinAmount: "" };
}
...
function createBaseMsgJoinSwapShareAmountOut(): MsgJoinSwapShareAmountOut {
  return { sender: "", poolId: Long.UZERO, tokenInDenom: "", shareOutAmount: "", tokenInMaxAmount: "" };
}
...
function createBaseMsgExitSwapShareAmountIn(): MsgExitSwapShareAmountIn {
  return { sender: "", poolId: Long.UZERO, tokenOutDenom: "", shareInAmount: "", tokenOutMinAmount: "" };
}
...
function createBaseMsgExitSwapExternAmountOut(): MsgExitSwapExternAmountOut {
  return { sender: "", poolId: Long.UZERO, tokenOut: undefined, shareInMaxAmount: "" };
}
...
export const MsgServiceName = "osmosis.gamm.v1beta1.Msg";
export class MsgClientImpl implements Msg {
  ...
  JoinSwapExternAmountIn(request: MsgJoinSwapExternAmountIn): Promise<MsgJoinSwapExternAmountInResponse> {
    ...
    const promise = this.rpc.request(this.service, "JoinSwapExternAmountIn", data);
    return promise.then((data) => MsgJoinSwapExternAmountInResponse.decode(_m0.Reader.create(data)));
  }

  JoinSwapShareAmountOut(request: MsgJoinSwapShareAmountOut): Promise<MsgJoinSwapShareAmountOutResponse> {
    const data = MsgJoinSwapShareAmountOut.encode(request).finish();
    const promise = this.rpc.request(this.service, "JoinSwapShareAmountOut", data);
    return promise.then((data) => MsgJoinSwapShareAmountOutResponse.decode(_m0.Reader.create(data)));
  }

  ExitSwapExternAmountOut(request: MsgExitSwapExternAmountOut): Promise<MsgExitSwapExternAmountOutResponse> {
    const data = MsgExitSwapExternAmountOut.encode(request).finish();
    const promise = this.rpc.request(this.service, "ExitSwapExternAmountOut", data);
    return promise.then((data) => MsgExitSwapExternAmountOutResponse.decode(_m0.Reader.create(data)));
  }

  ExitSwapShareAmountIn(request: MsgExitSwapShareAmountIn): Promise<MsgExitSwapShareAmountInResponse> {
    const data = MsgExitSwapShareAmountIn.encode(request).finish();
    const promise = this.rpc.request(this.service, "ExitSwapShareAmountIn", data);
    return promise.then((data) => MsgExitSwapShareAmountInResponse.decode(_m0.Reader.create(data)));
  }
}

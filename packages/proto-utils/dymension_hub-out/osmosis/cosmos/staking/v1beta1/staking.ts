...
export const Params = {
  encode(message: Params, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.keyRotationFee !== undefined) {
      Coin.encode(message.keyRotationFee, writer.uint32(58).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Params {
    return {
      ...
      keyRotationFee: isSet(object.keyRotationFee) ? Coin.fromJSON(object.keyRotationFee) : undefined,
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.keyRotationFee !== undefined) {
      obj.keyRotationFee = Coin.toJSON(message.keyRotationFee);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.keyRotationFee = (object.keyRotationFee !== undefined && object.keyRotationFee !== null)
      ? Coin.fromPartial(object.keyRotationFee)
      : undefined;
    return message;
  },
};
...
export const ConsPubKeyRotationHistory = {
  encode(message: ConsPubKeyRotationHistory, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.operatorAddress.length !== 0) {
      writer.uint32(10).bytes(message.operatorAddress);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ConsPubKeyRotationHistory {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ConsPubKeyRotationHistory {
    return {
      operatorAddress: isSet(object.operatorAddress) ? bytesFromBase64(object.operatorAddress) : new Uint8Array(0),
      oldConsPubkey: isSet(object.oldConsPubkey) ? Any.fromJSON(object.oldConsPubkey) : undefined,
      newConsPubkey: isSet(object.newConsPubkey) ? Any.fromJSON(object.newConsPubkey) : undefined,
  ...
  toJSON(message: ConsPubKeyRotationHistory): unknown {
    const obj: any = {};
    if (message.operatorAddress.length !== 0) {
      obj.operatorAddress = base64FromBytes(message.operatorAddress);
    }
    if (message.oldConsPubkey !== undefined) {
      obj.oldConsPubkey = Any.toJSON(message.oldConsPubkey);
    }
    if (message.newConsPubkey !== undefined) {
      obj.newConsPubkey = Any.toJSON(message.newConsPubkey);
    }
    if (!message.height.isZero()) {
  ...
  create<I extends Exact<DeepPartial<ConsPubKeyRotationHistory>, I>>(base?: I): ConsPubKeyRotationHistory {
    return ConsPubKeyRotationHistory.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ConsPubKeyRotationHistory>, I>>(object: I): ConsPubKeyRotationHistory {
    const message = createBaseConsPubKeyRotationHistory();
    message.operatorAddress = object.operatorAddress ?? new Uint8Array(0);
    message.oldConsPubkey = (object.oldConsPubkey !== undefined && object.oldConsPubkey !== null)
      ? Any.fromPartial(object.oldConsPubkey)
      : undefined;
    message.newConsPubkey = (object.newConsPubkey !== undefined && object.newConsPubkey !== null)
      ? Any.fromPartial(object.newConsPubkey)
      : undefined;
...
export const ValAddrsOfRotatedConsKeys = {
  encode(message: ValAddrsOfRotatedConsKeys, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.addresses) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ValAddrsOfRotatedConsKeys {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<ValAddrsOfRotatedConsKeys>, I>>(base?: I): ValAddrsOfRotatedConsKeys {
    return ValAddrsOfRotatedConsKeys.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ValAddrsOfRotatedConsKeys>, I>>(object: I): ValAddrsOfRotatedConsKeys {
    const message = createBaseValAddrsOfRotatedConsKeys();
    message.addresses = object.addresses?.map((e) => e) || [];
    return message;
  },
